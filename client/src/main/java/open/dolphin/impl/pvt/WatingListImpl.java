...
public class WatingListImpl extends AbstractMainComponent {
    ...
    // 来院情報をチェックするハンドラ
    private WatingListImpl.PvtChecker pvtChecker;
    ...
    private WatingListImpl.BitAndIconPair[] stateComboArray;
    ...
    private void setup() {
        ...
        stateComboArray = new WatingListImpl.BitAndIconPair[userBitArray.length];
        for (int i = 0; i < userBitArray.length; i++) {
            stateComboArray[i] = new WatingListImpl.BitAndIconPair(userBitArray[i], userIconArray[i]);
        }
        stateCmb = new JComboBox(stateComboArray);
        WatingListImpl.ComboBoxRenderer renderer= new WatingListImpl.ComboBoxRenderer();
    ...
    public void restartCheckTimer(int delay) {
        ...
        if (pvtChecker == null) {
            pvtChecker = new WatingListImpl.PvtChecker();
        }
    ...
    private void initComponents() {
        ...
        pvtTableModel = new ListTableModel<PatientVisitModel>(colunNames, START_NUM_ROWS, methods, cls) {
            ...
            public void setValueAt(Object value, int row, int col) {
                ...
                if (col == memoColumn) {
                    ...
                    WatingListImpl.BitAndIconPair pair = (WatingListImpl.BitAndIconPair)value;
        ...
        // 性別レンダラを生成する
        WatingListImpl.MaleFemaleRenderer sRenderer = new WatingListImpl.MaleFemaleRenderer();
        // Center Renderer
        WatingListImpl.CenterRenderer centerRenderer = new WatingListImpl.CenterRenderer();
        ...
        for (int i = 0; i < columnSpecs.size(); i++) {
            ...
            if (i == visitedTimeColumn || i == sexColumn) {
                ...
                // カルテ(PVT)状態レンダラ
                WatingListImpl.KarteStateRenderer renderer = new WatingListImpl.KarteStateRenderer();
    ...
    private void connect() {
        ...
        // コンテキストメニューを登録する
        view.getTable().addMouseListener(new WatingListImpl.ContextListener());
    ...
    protected class CenterRenderer extends WatingListImpl.MaleFemaleRenderer {
