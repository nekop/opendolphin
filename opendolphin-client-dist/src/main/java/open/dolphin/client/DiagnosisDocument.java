...
public final class DiagnosisDocument extends AbstractChartDocument implements PropertyChangeListener {
    ...
    private JPanel createDignosisPanel() {
        ...
        // 奇数、偶数行の色分けをする
        diagTable.setDefaultRenderer(Object.class, new DiagnosisDocument.DolphinOrcaRenderer());
        ...
        DiagnosisDocument.PopupListener pl1 = new DiagnosisDocument.PopupListener(tf);
        ...
        tf.addFocusListener(AutoRomanListener.getInstance());
        tf.setDocument(new RegexConstrainedDocument(datePattern));
        DiagnosisDocument.PopupListener pl2 = new DiagnosisDocument.PopupListener(tf);
    ...
    public void save() {
        ...
        DiagnosisDocument.DiagnosisPutTask task = new DiagnosisDocument.DiagnosisPutTask(getContext(), addedDiagnosis, updatedDiagnosis, sendDiagnosis, ddl);
        task.execute();
    }
...
//    }
    ...
    class PopupListener extends MouseAdapter implements PropertyChangeListener {
        ...
        public PopupListener(JTextField tf) {
            this.tf = tf;
            tf.addMouseListener(DiagnosisDocument.PopupListener.this);
        }
